...
import workflowDefaultIcon from '@/assets/imgs/workflow/workflow.png';
        ...
        <div className={styles.left}>
          <div className={styles.bot_info}>
            <img
              ...
              src={
                resolveImageUrl(props.coverUrl || props.detailInfo?.avatar) ||
                errorIcon
              }
              onError={e => {
                e.currentTarget.onerror = null;
                e.currentTarget.src = workflowDefaultIcon;
              }}
            />
          </div>
          <div>
