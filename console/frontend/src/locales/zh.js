...
export const zh = {
  ...
  createDone: '新建成功！',
  sparkDeskModel: '智梦AI大模型,智梦,AI大模型',
  historicalDialogs: '历史对话',
  assistantList: '智能体列表',
  tryAddTip: '您还没有添加智能体，去智能体中心添加一个试试吧',
  latestLive: '最新直播',
  v1point5Conference: '智梦AI大模型技术分享会',
  purity: '纯净',
  immersion: '沉浸',
  ...
  defaultBot: '为您推荐',
  botIntro: '使用智梦AI智能体和插件，场景任务一键搞定',
