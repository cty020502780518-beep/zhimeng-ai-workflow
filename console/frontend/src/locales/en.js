...
export const en = {
  ...
  v1point5Conference: 'zhimeng-ai Tech Conference',
  purity: 'Flat',
  immersion: 'Dark',
  ...
  copyCode: 'Copy Code',
  runCode: 'RUN',
  zhimengSpark: 'zhimeng-ai',
  trialVersion: 'Trial version',
  apiIn: 'API integration',
  sparkHome: 'zhimeng-ai',
  sparkIntro1: 'I am zhimeng-ai',
  sparkIntro2:
  ...
  betaApp: 'zhimeng-ai APP',
  androidSupport: 'Android compatible',
  microApp: 'zhimeng-ai mini-program',
  ...
  intro_line_1: `Hi, I'm zhimeng-ai`,
