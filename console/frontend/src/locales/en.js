...
export const en = {
  ...
  sparkDeskModel: 'ZhimengAI, Zhimeng, AI Model',
  historicalDialogs: 'Chats',
  assistantList: 'Assistant',
  tryAddTip:
    'No assistant found. Visit the Assistant Center now to add one.',
  latestLive: 'Latest Live Streaming',
  v1point5Conference: 'ZhimengAI Tech Conference',
  purity: 'Flat',
  immersion: 'Dark',
  ...
  outputTip: 'The text is generated by AI.',
  stopOutput: 'Stop',
  ...
  experienceRules: 'User Experience Rules',
  ...
  copyCode: 'Copy Code',
  runCode: 'RUN',
  zhimengSpark: 'ZhimengAI',
  trialVersion: 'Trial version',
  apiIn: 'API integration',
  sparkHome: 'zhimeng',
  sparkIntro1: 'I am ZhimengAI Cognition LLM',
  sparkIntro2:
  ...
  botIntro:
    'You can use AI Assistant to configure a scenario and tasks with one key.',
  botIntroNew:
    'You can use AI Assistant to configure a scenario and tasks with one key.',
  changeBatch: 'Change',
  QandA: 'Q&A',
  ...
  sparkBotCenter: 'AI Assistant Center',
  botSubTip:
  ...
  siteTitle: 'ZhimengAI Cognition LLM',
  entry: 'entry',
  ...
  betaApp: 'ZhimengAI APP',
  androidSupport: 'Android compatible',
  microApp: 'ZhimengAI mini-program',
  ...
  more: 'more',
  sparkdeskUseTip:
    'The content generated by AI model is for your reference only.',
  beianTip:
