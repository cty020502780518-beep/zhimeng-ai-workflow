...
import com.zhimeng.ai.console.toolkit.tool.CommonTool;
import com.zhimeng.ai.console.toolkit.tool.http.HeaderAuthHttpTool;
...
class AppServiceTest {
    ...
    void getAkSk_shouldThrow_whenArrayEmpty() throws Exception {
        ...
        Class<?> springUtils = Class.forName("com.zhimeng.ai.console.toolkit.util.SpringUtils");
