package com.zhimeng.ai.console.toolkit.service.model;
...
import com.zhimeng.ai.console.toolkit.entity.biz.modelconfig.*;
...
import com.zhimeng.ai.console.toolkit.entity.table.model.ModelCommon;
import com.zhimeng.ai.console.toolkit.entity.vo.CategoryTreeVO;
import com.zhimeng.ai.console.toolkit.entity.vo.LLMInfoVo;
import com.zhimeng.ai.console.toolkit.entity.vo.ModelCategoryReq;
...
import com.zhimeng.ai.console.toolkit.mapper.model.ModelMapper;
import com.zhimeng.ai.console.toolkit.mapper.workflow.WorkflowMapper;
import com.zhimeng.ai.console.toolkit.handler.LocalModelHandler;
...
class ModelServiceTest {
    ...
    void testValidateModel_createNew_decrypt_success() {
        ...
        try (MockedStatic<com.zhimeng.ai.console.toolkit.util.idata.RSAUtil> rsa = mockStatic(com.zhimeng.ai.console.toolkit.util.idata.RSAUtil.class)) {
            RSAPrivateKey mockKey = mock(RSAPrivateKey.class);
            rsa.when(() -> com.zhimeng.ai.console.toolkit.util.idata.RSAUtil.loadPrivateKey(anyString()))
                    .thenReturn(mockKey);
            rsa.when(() -> com.zhimeng.ai.console.toolkit.util.idata.RSAUtil.decryptByPrivateKeyBase64(eq("ENCRYPTED_BASE64"), eq(mockKey)))
            ...
            try (MockedStatic<com.zhimeng.ai.console.commons.util.space.SpaceInfoUtil> space = mockStatic(com.zhimeng.ai.console.commons.util.space.SpaceInfoUtil.class)) {
                space.when(com.zhimeng.ai.console.commons.util.space.SpaceInfoUtil::getSpaceId).thenReturn(1001L);
    ...
    void testLocalModel_create_ok_withContextLength() {
        ...
        com.zhimeng.ai.console.toolkit.entity.table.model.ModelCategory cat = new com.zhimeng.ai.console.toolkit.entity.table.model.ModelCategory();
        cat.setId(999L);
        cat.setName("128k");
        ...
        // space id
        try (MockedStatic<com.zhimeng.ai.console.commons.util.space.SpaceInfoUtil> space = mockStatic(com.zhimeng.ai.console.commons.util.space.SpaceInfoUtil.class)) {
            space.when(com.zhimeng.ai.console.commons.util.space.SpaceInfoUtil::getSpaceId).thenReturn(2002L);
    ...
    void testSwitchModel_enable_on_success_and_unauthorized() {
        // Authorized path
        try (MockedStatic<com.zhimeng.ai.console.toolkit.handler.UserInfoManagerHandler> u = mockStatic(com.zhimeng.ai.console.toolkit.handler.UserInfoManagerHandler.class)) {
            u.when(com.zhimeng.ai.console.toolkit.handler.UserInfoManagerHandler::getUserId).thenReturn("u1");
        ...
        // Unauthorized path
        try (MockedStatic<com.zhimeng.ai.console.toolkit.handler.UserInfoManagerHandler> u = mockStatic(com.zhimeng.ai.console.toolkit.handler.UserInfoManagerHandler.class)) {
            u.when(com.zhimeng.ai.console.toolkit.handler.UserInfoManagerHandler::getUserId).thenReturn("u2");
