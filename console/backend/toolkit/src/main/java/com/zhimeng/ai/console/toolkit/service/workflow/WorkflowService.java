package com.zhimeng.ai.console.toolkit.service.workflow;
...
import com.zhimeng.ai.console.commons.entity.user.UserInfo;
import com.zhimeng.ai.console.commons.entity.workflow.Workflow;
...
import com.zhimeng.ai.console.commons.mapper.UserLangChainInfoMapper;
import com.zhimeng.ai.console.commons.mapper.bot.ChatBotBaseMapper;
import com.zhimeng.ai.console.commons.response.ApiResult;
import com.zhimeng.ai.console.commons.service.bot.BotMarketDataService;
import com.zhimeng.ai.console.commons.util.RequestContextUtil;
import com.zhimeng.ai.console.commons.util.SseEmitterUtil;
import com.zhimeng.ai.console.commons.util.space.SpaceInfoUtil;
import com.zhimeng.ai.console.toolkit.common.Result;
import com.zhimeng.ai.console.toolkit.common.constant.CommonConst;
import com.zhimeng.ai.console.toolkit.common.constant.WorkflowConst;
import com.zhimeng.ai.console.toolkit.config.properties.ApiUrl;
import com.zhimeng.ai.console.toolkit.config.properties.BizConfig;
import com.zhimeng.ai.console.toolkit.config.properties.CommonConfig;
import com.zhimeng.ai.console.toolkit.entity.biz.external.app.AkSk;
import com.zhimeng.ai.console.toolkit.entity.biz.workflow.*;
import com.zhimeng.ai.console.toolkit.entity.biz.workflow.channel.AiuiAgentInfo;
import com.zhimeng.ai.console.toolkit.entity.biz.workflow.node.*;
import com.zhimeng.ai.console.toolkit.entity.common.PageData;
import com.zhimeng.ai.console.toolkit.entity.core.workflow.*;
import com.zhimeng.ai.console.toolkit.entity.core.workflow.node.InputOutput;
import com.zhimeng.ai.console.toolkit.entity.core.workflow.node.NodeData;
import com.zhimeng.ai.console.toolkit.entity.core.workflow.node.Property;
import com.zhimeng.ai.console.toolkit.entity.core.workflow.node.Schema;
import com.zhimeng.ai.console.toolkit.entity.core.workflow.sse.ChatResponse;
import com.zhimeng.ai.console.toolkit.entity.core.workflow.sse.ChatSysReq;
import com.zhimeng.ai.console.toolkit.entity.dto.*;
import com.zhimeng.ai.console.toolkit.entity.dto.eval.NodeSimpleDto;
import com.zhimeng.ai.console.toolkit.entity.dto.eval.WorkflowComparisonSaveReq;
import com.zhimeng.ai.console.toolkit.entity.dto.talkagent.TalkAgentConfigDto;
import com.zhimeng.ai.console.toolkit.entity.table.ConfigInfo;
import com.zhimeng.ai.console.toolkit.entity.table.database.DbTable;
import com.zhimeng.ai.console.toolkit.entity.table.eval.EvalSet;
import com.zhimeng.ai.console.toolkit.entity.table.eval.EvalSetVer;
import com.zhimeng.ai.console.toolkit.entity.table.eval.EvalSetVerData;
import com.zhimeng.ai.console.toolkit.entity.table.model.Model;
import com.zhimeng.ai.console.toolkit.entity.table.relation.FlowDbRel;
import com.zhimeng.ai.console.toolkit.entity.table.relation.FlowRepoRel;
import com.zhimeng.ai.console.toolkit.entity.table.relation.FlowToolRel;
import com.zhimeng.ai.console.toolkit.entity.table.repo.FileInfoV2;
import com.zhimeng.ai.console.toolkit.entity.table.tool.*;
import com.zhimeng.ai.console.toolkit.entity.table.workflow.*;
import com.zhimeng.ai.console.toolkit.entity.tool.McpServerTool;
import com.zhimeng.ai.console.toolkit.entity.vo.*;
import com.zhimeng.ai.console.toolkit.entity.vo.eval.EvalSetVerDataVo;
import com.zhimeng.ai.console.toolkit.handler.*;
import com.zhimeng.ai.console.toolkit.mapper.ConfigInfoMapper;
import com.zhimeng.ai.console.toolkit.mapper.database.DbTableMapper;
import com.zhimeng.ai.console.toolkit.mapper.eval.EvalSetMapper;
import com.zhimeng.ai.console.toolkit.mapper.eval.EvalSetVerDataMapper;
import com.zhimeng.ai.console.toolkit.mapper.eval.EvalSetVerMapper;
import com.zhimeng.ai.console.toolkit.mapper.relation.FlowDbRelMapper;
import com.zhimeng.ai.console.toolkit.mapper.relation.FlowRepoRelMapper;
import com.zhimeng.ai.console.toolkit.mapper.relation.FlowToolRelMapper;
import com.zhimeng.ai.console.toolkit.mapper.repo.FileInfoV2Mapper;
import com.zhimeng.ai.console.toolkit.mapper.tool.*;
import com.zhimeng.ai.console.toolkit.mapper.trace.ChatInfoMapper;
import com.zhimeng.ai.console.toolkit.mapper.trace.NodeInfoMapper;
import com.zhimeng.ai.console.toolkit.mapper.workflow.*;
import com.zhimeng.ai.console.toolkit.service.extra.AppService;
import com.zhimeng.ai.console.toolkit.service.extra.CoreSystemService;
import com.zhimeng.ai.console.toolkit.service.extra.OpenPlatformService;
import com.zhimeng.ai.console.toolkit.service.model.ModelService;
import com.zhimeng.ai.console.toolkit.sse.WorkflowSseEventSourceListener;
import com.zhimeng.ai.console.toolkit.tool.DataPermissionCheckTool;
import com.zhimeng.ai.console.toolkit.tool.JsonConverter;
import com.zhimeng.ai.console.toolkit.tool.MyThreadTool;
import com.zhimeng.ai.console.toolkit.util.JacksonUtil;
import com.zhimeng.ai.console.toolkit.util.OkHttpUtil;
import com.zhimeng.ai.console.toolkit.util.RedisUtil;
import com.zhimeng.ai.console.toolkit.util.S3Util;
import com.zhimeng.ai.console.toolkit.util.SpringUtils;
import com.zhimeng.ai.console.toolkit.util.ssrf.SsrfParamGuard;
import com.zhimeng.ai.console.toolkit.util.ssrf.SsrfProperties;
import com.zhimeng.ai.console.toolkit.util.ssrf.SsrfValidators;
...
public class WorkflowService extends ServiceImpl<WorkflowMapper, Workflow> {
    ...
    private void inputCopy(List<BizInputOutput> bizInputs, List<InputOutput> inputs) {
        ...
        bizInputs.forEach(bi -> {
            ...
            if (bv != null) {
                com.zhimeng.ai.console.toolkit.entity.core.workflow.node.Value v = new com.zhimeng.ai.console.toolkit.entity.core.workflow.node.Value();
