package com.zhimeng.ai.console.hub.service.chat.impl;
...
import com.zhimeng.ai.console.commons.service.bot.BotService;
import com.zhimeng.ai.console.commons.service.bot.ChatBotDataService;
import com.zhimeng.ai.console.commons.service.data.ChatDataService;
import com.zhimeng.ai.console.commons.service.data.ChatHistoryService;
import com.zhimeng.ai.console.commons.service.data.ChatListDataService;
import com.zhimeng.ai.console.commons.service.workflow.WorkflowBotChatService;
...
import com.zhimeng.ai.console.hub.data.ReqKnowledgeRecordsDataService;
import com.zhimeng.ai.console.hub.entity.ReqKnowledgeRecords;
import com.zhimeng.ai.console.hub.service.PromptChatService;
import com.zhimeng.ai.console.hub.service.chat.BotChatService;
import com.zhimeng.ai.console.hub.service.chat.ChatListService;
import com.zhimeng.ai.console.hub.service.knowledge.KnowledgeService;
import com.zhimeng.ai.console.toolkit.entity.vo.CategoryTreeVO;
import com.zhimeng.ai.console.toolkit.entity.vo.LLMInfoVo;
import com.zhimeng.ai.console.toolkit.service.model.LLMService;
...
public class BotChatServiceImpl implements BotChatService {
        ...
        try {
            ...
            if (botConfig.version.equals(BotTypeEnum.WORKFLOW_BOT.getType())) {
                ...
                if (botConfig.modelId == null) {
                    ...
                    JSONObject jsonObject = buildDefaultChatRequest(botConfig.model, messages, botConfig.openedTool);
    ...
    public void debugChatMessageBot(String text, String prompt, List<String> messages, String uid, String openedTool, String model, Long modelId, List<String> maasDatasetList, SseEmitter sseEmitter, String sseId) {
        try {
            ...
            if (modelId == null) {
                ...
                JSONObject jsonObject = buildDefaultChatRequest(model, messageList, openedTool);
    ...
    /**
     * Build JSON request for the default (built-in) LLM provider.
     */
    private JSONObject buildDefaultChatRequest(String model, List<SparkChatRequest.MessageDto> messages, String openedTool) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("url", defaultLlmUrl + "/chat/completions");
        jsonObject.put("apiKey", defaultLlmApiKey);
        jsonObject.put("model", model);
        jsonObject.put("messages", messages);
        jsonObject.put("enableWebSearch", enableWebSearch(openedTool));
        return jsonObject;
    }
