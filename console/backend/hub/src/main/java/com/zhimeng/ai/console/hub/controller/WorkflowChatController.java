package com.zhimeng.ai.console.hub.controller;
...
import com.zhimeng.ai.console.hub.service.WorkflowChatService;
...
@Tag(name = "Workflow Chat", description = "Workflow chat API with SSE streaming")
@Validated
