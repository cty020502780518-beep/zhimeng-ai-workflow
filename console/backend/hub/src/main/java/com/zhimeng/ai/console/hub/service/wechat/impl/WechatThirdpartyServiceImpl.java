...
import com.zhimeng.ai.console.hub.dto.wechat.WechatAuthCallbackDto;
...
public class WechatThirdpartyServiceImpl implements WechatThirdpartyService {
    ...
    public void refreshVerifyTicket(String decryptedXml) {
        ...
        try {
            ...
            Map<String, String> ticketMsg = com.zhimeng.ai.console.hub.util.wechat.WXBizMsgParse.parseTicketMsg(decryptedXml);
