...
import com.zhimeng.ai.console.commons.dto.space.SpaceUserParam;
import com.zhimeng.ai.console.commons.dto.space.SpaceUserVO;
...
import com.zhimeng.ai.console.commons.mapper.space.SpaceUserMapper;
...
class SpaceUserServiceImplTest {
    ...
    void updateVisitTime_WithValidParameters_ShouldTestMethodExists() {
        ...
        assertTrue(spaceUserService instanceof com.zhimeng.ai.console.commons.service.space.SpaceUserService,
    ...
    void updateBatchById_WithValidEntityList_ShouldTestMethodExists() {
        ...
        assertTrue(com.zhimeng.ai.console.commons.service.space.SpaceUserService.class
