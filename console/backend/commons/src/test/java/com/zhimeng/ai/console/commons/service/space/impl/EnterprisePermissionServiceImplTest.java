...
import com.zhimeng.ai.console.commons.mapper.space.EnterprisePermissionMapper;
...
class EnterprisePermissionServiceImplTest {
    ...
    void listByKeys_MethodExistsAndImplementsCorrectInterface() {
        ...
        assertTrue(enterprisePermissionService instanceof com.zhimeng.ai.console.commons.service.space.EnterprisePermissionService,
    ...
    void listByKeys_WithSingleKey_TestMethodAccessibility() {
        ...
        assertDoesNotThrow(() -> {
            ...
            java.lang.reflect.Method interfaceMethod = com.zhimeng.ai.console.commons.service.space.EnterprisePermissionService.class
                    .getMethod("listByKeys", Collection.class);
    ...
    void verifyQueryWrapperConstruction_ListByKeys() {
        ...
        assertTrue(com.zhimeng.ai.console.commons.service.space.EnterprisePermissionService.class
