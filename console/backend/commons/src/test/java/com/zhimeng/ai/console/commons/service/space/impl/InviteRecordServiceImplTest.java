...
import com.zhimeng.ai.console.commons.dto.space.InviteRecordParam;
...
import com.zhimeng.ai.console.commons.enums.space.InviteRecordStatusEnum;
...
import com.zhimeng.ai.console.commons.mapper.space.InviteRecordMapper;
...
class InviteRecordServiceImplTest {
    ...
    void saveBatch_WithValidEntityList_ShouldReturnTrue() {
        ...
        assertTrue(com.zhimeng.ai.console.commons.service.space.InviteRecordService.class
    ...
    void saveBatch_WithEmptyCollection_ShouldTestMethodVisibility() {
        ...
        assertDoesNotThrow(() -> {
            ...
            java.lang.reflect.Method interfaceMethod = com.zhimeng.ai.console.commons.service.space.InviteRecordService.class
                    .getMethod("saveBatch", Collection.class);
    ...
    void updateExpireRecord_ShouldTestMethodExistsAndCallable() {
        ...
        assertTrue(inviteRecordService instanceof com.zhimeng.ai.console.commons.service.space.InviteRecordService,
                "Service should implement InviteRecordService interface");
    }
