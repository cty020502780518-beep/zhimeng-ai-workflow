...
import com.zhimeng.ai.console.commons.mapper.space.SpacePermissionMapper;
...
class SpacePermissionServiceImplTest {
    ...
    void listByKeys_MethodExistsAndImplementsCorrectInterface() {
        ...
        assertTrue(spacePermissionService instanceof com.zhimeng.ai.console.commons.service.space.SpacePermissionService,
    ...
    void listByKeys_WithSingleKey_TestMethodAccessibility() {
        ...
        assertDoesNotThrow(() -> {
            ...
            java.lang.reflect.Method interfaceMethod = com.zhimeng.ai.console.commons.service.space.SpacePermissionService.class
                    .getMethod("listByKeys", Collection.class);
    ...
    void verifyQueryWrapperConstruction_ListByKeys() {
        ...
        assertTrue(com.zhimeng.ai.console.commons.service.space.SpacePermissionService.class
