...
# 查看日志
docker logs -f zhimeng-agent-core-workflow-java
```
...
```bash
# 查看 Python 版本的日志
docker logs -f zhimeng-agent-core-workflow-python
...
# 进入容器调试
docker exec -it zhimeng-agent-core-workflow-java sh
```
## 相关文档
